...
"[project]/src/app/campaign/channel/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CampaignChannel() {
    ...
    const [tab, setTab] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("recent");
    const [channelVideos, setChannelVideos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [channelId, setChannelId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [hasSavedChannel, setHasSavedChannel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [loadingInitialChannel, setLoadingInitialChannel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // Load channels from backend and sessionStorage on mount
    const loadSavedChannels = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CampaignChannel.useCallback[loadSavedChannels]": async ()=>{
            if (("TURBOPACK compile-time value", "object") === "undefined" || !verifiedEmail) {
    ...
    }["CampaignChannel.useCallback[loadSavedChannels]"], [
        verifiedEmail
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CampaignChannel.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CampaignChannel.useEffect": ()=>{
            ...
            try {
                const parsed = JSON.parse(sessionStorage.getItem(STORAGE_KEY) || "[]");
                setVideos(parsed);
                setSelectedIds(parsed.slice(0, 5).map({
                    "CampaignChannel.useEffect": (video)=>video.videoId
                }["CampaignChannel.useEffect"]));
                const channelKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$verifiedEmail$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSelectedChannelKey"])();
                const savedChannelId = localStorage.getItem(channelKey);
                if (savedChannelId) {
                    ...
                    const withChannel = parsed.find({
                        "CampaignChannel.useEffect.withChannel": (video)=>!!video.channelId
                    }["CampaignChannel.useEffect.withChannel"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CampaignChannel.useEffect": ()=>{
            const handleChannelChange = {
                "CampaignChannel.useEffect.handleChannelChange": (event)=>{
            ...
            }["CampaignChannel.useEffect.handleChannelChange"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CampaignChannel.useEffect": ()=>{
            const fetchChannelVideos = {
                "CampaignChannel.useEffect.fetchChannelVideos": async ()=>{
                    if (!channelId) return;
                    try {
                        ...
                        if (!response.ok) {
                            const data = await response.json().catch({
                                "CampaignChannel.useEffect.fetchChannelVideos": ()=>({})
                            }["CampaignChannel.useEffect.fetchChannelVideos"]);
                            throw new Error(data?.message || "Unable to load channel videos");
                        }
                        const data = await response.json();
                        const mapped = (data.videos || []).map({
                            "CampaignChannel.useEffect.fetchChannelVideos.mapped": (video)=>({
                                    title: video.title,
                                    author: video.author,
                        ...
                        }["CampaignChannel.useEffect.fetchChannelVideos.mapped"]);
    ...
    const mergedVideos = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CampaignChannel.useMemo[mergedVideos]": ()=>{
            if (channelVideos.length) return channelVideos;
            if (channelId) return videos.filter({
                "CampaignChannel.useMemo[mergedVideos]": (video)=>video.channelId === channelId
            }["CampaignChannel.useMemo[mergedVideos]"]);
            return videos;
        }
    }["CampaignChannel.useMemo[mergedVideos]"], [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CampaignChannel.useEffect": ()=>{
            if (channelVideos.length > 0 && selectedIds.length === 0) {
                const availableIds = channelVideos.slice(0, 5).map({
                    "CampaignChannel.useEffect.availableIds": (v)=>v.videoId
                }["CampaignChannel.useEffect.availableIds"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CampaignChannel.useEffect": ()=>{
            const fetchSearch = {
                "CampaignChannel.useEffect.fetchSearch": async ()=>{
                    ...
                    try {
                        ...
                        if (!response.ok) {
                            const data = await response.json().catch({
                                "CampaignChannel.useEffect.fetchSearch": ()=>({})
                            }["CampaignChannel.useEffect.fetchSearch"]);
                            throw new Error(data?.message || "Unable to search channel videos");
                        }
                        const data = await response.json();
                        const mapped = (data.videos || []).slice(0, 5).map({
                            "CampaignChannel.useEffect.fetchSearch.mapped": (video)=>({
                                    title: video.title,
                                    author: video.author,
                                    videoId: video.videoId,
                                    thumbnail: video.thumbnail,
                        ...
                        }["CampaignChannel.useEffect.fetchSearch.mapped"]);
    ...
    const filteredVideos = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CampaignChannel.useMemo[filteredVideos]": ()=>{
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                !channelId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        channelError && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(CampaignChannel, "q/usTTWRbVD1xQ36vN2hGia//II=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = CampaignChannel;
var _c;
__turbopack_context__.k.register(_c, "CampaignChannel");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_9a5c52fd._.js.map