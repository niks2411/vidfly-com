...
import { Youtube, Camera, Play, CheckCircle } from "lucide-react";
...
export default function YoutubeVloggingPromotion() {
    ...
    return (
        <div className="min-h-screen bg-white font-founders">
            ...
            <div className="px-2 lg:px-4">
                <header className="relative w-full min-h-[600px] flex items-center bg-[#1a1a2e] overflow-hidden">
                    ...
                    <div className="absolute inset-0 z-0 overflow-hidden ">
                        <Image
                            src="/bgvlog.webp"
                            alt="Vlogging Promotion Background"
                            fill
                        ...
                        <div className="max-w-3xl space-y-6">
                            <Animated delay={50}>
                                ...
                                <h1
                                    ...
                                    style={{
                                        background: "linear-gradient(90deg, #ff4e50 0%, #f9d423 40%, #fdf2b1 70%, #ff4e50 100%)",
                                ...
                                <button
                                    ...
                                    className="bg-gradient-to-r from-[#e52d27] to-[#b31217] text-white font-black text-[18px] px-10 py-5 rounded-[4px] shadow-2xl hover:scale-[1.03] transition-all duration-300 transform uppercase tracking-tight"
                                >
                                    Promote My Vlog Video
                                </button>
                            </Animated>
                        </div>
                    </div>
            ...
            {/* WHY CREATORS CHOOSE VIDFLYY */}
            <section className="py-20 bg-white font-founders">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12 lg:mb-16">
                        <Animated delay={100}>
                            <div className="flex justify-center mb-6">
                                <span className="bg-gradient-to-r from-[#e52d27] to-[#b31217] text-white text-[12px] font-extrabold px-5 py-2 tracking-wide uppercase shadow-lg shadow-red-500/20">
                                    Vlogging Promotion Services
                                </span>
                            </div>
                            <h2 className="section-heading !mb-4">
                                Why <span className="bg-gradient-to-r from-[#e52d27] to-[#b31217] bg-clip-text text-transparent">Vloggers</span> choose Vidflyy to Grow.
                            </h2>
                            <p className="section-desc max-w-3xl mx-auto">
                                Built for daily vloggers and lifestyle creators who want real reach, real subscribers, and real community growth — without fake views.
                            </p>
                        </Animated>
                    </div>
                    <div className="space-y-8">
                            ...
                            <div className="bg-[#F3F4F6] overflow-hidden flex flex-col md:flex-row items-stretch border border-gray-100 shadow-sm transition-all duration-500 hover:shadow-md group">
                                <div className="p-6 lg:p-10 md:w-[60%] flex flex-col justify-center">
                                    <h3 className="text-[24px] lg:text-[32px] font-bold text-[#0E172B] mb-4 leading-tight">
                                        No Bots, Just Real Vlog Fans.<br />Reach New Viewers for Your Channel.
                                    </h3>
                                    <p className="text-[#475569] text-[16px] lg:text-[18px] leading-relaxed font-medium">
                                        Your vlog is promoted to audiences who actually watch daily vlogs, lifestyle videos, and personal stories — not random traffic.
                                    </p>
                                </div>
                        ...
                        <Animated delay={400}>
                            <div className="bg-[#F3F4F6] overflow-hidden flex flex-col md:flex-row items-stretch border border-gray-100 shadow-sm transition-all duration-500 hover:shadow-md group">
                                <div className="p-6 lg:p-10 md:w-[60%] flex flex-col justify-center">
                                    <h3 className="text-[24px] lg:text-[32px] font-bold text-[#0E172B] mb-4 leading-tight">
                                        Launch Vlog Campaigns in Seconds
                                    </h3>
                                    <p className="text-[#475569] text-[16px] lg:text-[18px] leading-relaxed font-medium mb-6">
                                        Launch your vlogging campaign in seconds and start reaching real viewers without delays or complex setup.
                                    </p>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                        <div>
                            <h3 className="text-[28px] lg:text-[36px] font-black text-[#0E172B] leading-tight mb-3">
                                Ready to Promote Your Next Vlog?
                            </h3>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <Animated delay={60}>
                        <h3 className="section-heading text-left sm:text-center !mb-16 music-white-heading">
                            How Vidflyy vlog promotion works
                        </h3>
                    </Animated>
                    ...
                    <div className="grid grid-cols-2 lg:flex lg:flex-row items-start justify-center gap-y-12 lg:gap-0">
                        <Animated delay={100} className="flex flex-col items-center text-center px-2">
                            ...
                            <p className="text-gray-400 text-xs leading-relaxed max-w-[140px] lg:max-w-[180px]">
                                Add your YouTube vlog video, choose your budget and targeting.
                            </p>
                        </Animated>
            ...
            <PromotionBanner
                ...
                heading={
                    <>
                        Start promoting your vlog <br className="hidden lg:block" />
                        today and reach viewers who <br className="hidden lg:block" />
                        truly connect with your life.
                    </>
                }
                description="Launch your campaign in seconds, get real subscribers, track performance live, and grow your community with full control."
            />
