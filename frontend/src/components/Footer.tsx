        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-3">
              <a href="https://in.linkedin.com/company/vidflyy" target="_blank" rel="noopener noreferrer" className="w-[30px] h-[30px] bg-[#E52D27] rounded-[4px] flex items-center justify-center hover:bg-[#CC2420] transition-colors">
              ...
              <a href="https://www.instagram.com/vidflyy/" target="_blank" rel="noopener noreferrer" className="w-[30px] h-[30px] bg-[#E52D27] rounded-[4px] flex items-center justify-center hover:bg-[#CC2420] transition-colors">
              ...
              <a href="https://www.facebook.com/Vidflyy/" target="_blank" rel="noopener noreferrer" className="w-[30px] h-[30px] bg-[#E52D27] rounded-[4px] flex items-center justify-center hover:bg-[#CC2420] transition-colors">
          ...
          <div className="flex flex-col items-start gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <a href="mailto:Support@vidflyy.com" className="text-[14px] font-bold text-[#111] hover:text-[#E52D27]">
                  Support@vidflyy.com
                </a>
              </div>
            </div>
