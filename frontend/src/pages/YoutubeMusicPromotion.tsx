...
const YoutubeMusicPromotion: React.FC = () => {
  ...
  const handleUrlChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setVideoUrl(url);
    // Simple validation: contains youtube.com or youtu.be
  ...
  const handlePromoteClick = () => {
    if (isValidUrl) {
      ...
      navigate('/campaign', { state: { youtubeLink: videoUrl } });
    }
  };
            ...
            <Animated className="" delay={50}>
              <div className="space-y-6">
                ...
                <div className="pt-2">
                  ...
                  {/* Mobile button if needed, but the responsive design handles hidden/block */}
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            {/* Left - Video Mockup with Circular Text */}
            <Animated delay={100}>
